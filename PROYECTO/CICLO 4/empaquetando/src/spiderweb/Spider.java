...
public class Spider {
    ...
    /**
     * Return the min bridges to add on the web to reach the spot
     * 
     * @param strands  the number of strands in the web
    ...
    public ArrayList<int[]> bridgesToAdd(int strands, int favorite, int[][] bridges, int strand) {
        int originalStrand = this.strand;
        ArrayList<int[]> leftBridges;
        ArrayList<int[]> rightBridges;
        this.strand = strand;
    ...
    /**
     * Return the strand where the spider is
     * 
     * @return the strand where the spider is located.
     */
    ...
    private Bridge bridgeToGo(HashMap<String, Bridge> bridges) {
        ...
        for (Bridge bridge : bridges.values()) {
            bridgesInStrand
                    .add((bridge.getInicialStrand() == this.strand || bridge.getFinalStrand() == this.strand) ? bridge
                            : null);
        }
    ...
    /*
     * Return the number of bridges to be added on the left for each strand to reach
     * the spot
     */
    private ArrayList<int[]> addBridgesLeft(int[][] bridges, int favorite, int strands) {
        ...
        for (int[] b : bridges) {
            ...
            newDistance = ((b[1] == favorite || finalStrand == favorite) && b[0] == newDistance) ? newDistance + 10
                    : newDistance;
        }
    ...
    /*
     * Return the number of bridges to be added on the right for each strand to
     * reach the spot
     */

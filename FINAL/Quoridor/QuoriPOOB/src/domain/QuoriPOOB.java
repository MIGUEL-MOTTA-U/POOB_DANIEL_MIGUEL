...
public class QuoriPOOB {
	 ...
	 * with wrong parameters, or before create two players.
	 */
	 ...
	 * @throws QuoriPOOBException	Throws an Exception in case the attempt to more than 
	 * two players, or create a player with wrong parameters.
	 */
	...
	/**
	 * Creates a Machine Player for QuoriPOOB and integrate it to the Game according to 
	 * the respective difficulty.
	 * @param color	The color of the Machine Player.
	 * @param type	The Type (difficulty) of the Machine.
	 * @throws QuoriPOOBException	Throws an Exception in case there is other Machine created, 
	 * or in case the given parameters are wrong, or there are two players already.
	 */
	 ...
	 * add the Walls and there are not players created or a Board created, 
	 * also if the parameters are wrong.
	 */
	 ...
	 * @throws QuoriPOOBException	Throws an Exception in case the given parameters are wrong 
	 * or the action is not possible.
	 */
	 ...
	 * @throws QuoriPOOBException	Throws an exception in case the parameters are wrong 
	 * or the action is not possible.
	 */

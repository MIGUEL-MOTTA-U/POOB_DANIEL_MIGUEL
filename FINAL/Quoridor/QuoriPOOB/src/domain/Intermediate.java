...
public class Intermediate extends Machine {
    ...
    private void play(String direction) throws QuoriPOOBException {
        // Este metodo debe calcular la distancia minima del otro jugador y la propia
        // para llegar al final
        // Si la distancia menor para llegar al destino es mia o igual, yo me muevo
        // adelante
        // Si no coloco un muro buscando obstaculizar el del contrincante en su camino
        // mas corto
